function Classify_aliens(){

    navigator.mediaDevices.getUserMedia({audio : true});
    classifier = ml5.soundClassifier("https://teachablemachine.withgoogle.com/models/YDnoatL1a/model.json", modelReady);
}
...
function gotResults(error, results){
    if (error) {
        ...
        else if (results[0].label == "Clicky pen") {
            img.src = "aliens-01.png";
            img1.src = "aliens-02.png";
